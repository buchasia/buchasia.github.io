...
<div align="center"><img src="pipeline-with-default-parameters.png" alt="Fabric pipeline with default notebook parameters" /></div>
...
<div align="center"><img src="vl-in-new-item.png" alt="Variable library in the New item menu" /></div>
...
<div align="center"><img src="vl-name-your-vl.png" alt="Create a new variable library" /></div>
...
<div align="center"><img src="vl-new-variable-button.png" alt="Empty variable library" /></div>
...
<div align="center"><img src="vl-create-variables.png" alt="Variables in the default value set" /></div>
...
<div align="center"><img src="pl-add-library-variables-to-pipeline.png" alt="Add library variables to the pipeline" /></div>
...
<div align="center"><img src="pl-switch-to-library-variables.png" alt="Switch the expression builder to library variables" /></div>
...
<div align="center"><img src="pl-variable-now-present-for-pl.png" alt="Library variables available in the pipeline" /></div>
...
<div align="center"><img src="pl-add-dynamic-content-for-value.png" alt="Add dynamic content for a pipeline parameter" /></div>
...
<div align="center"><img src="pl-select-variable-from-library.png" alt="Select a variable from the variable library" /></div>
...
<div align="center"><img src="pl-final-dynamic-content.png" alt="Dynamic content expression referencing a library variable" /></div>
...
<div align="center"><img src="pl-final-all-nb-parameters.png" alt="All notebook parameters using library variables" /></div>
...
<div align="center"><img src="vl-add-value-set.png" alt="Add a value set" /></div>

Enter a name for the new set and create it. In this example, the alternative set is called `PROD`.

<div align="center"><img src="vl-name-alternate-value-set.png" alt="Name the alternative value set" /></div>
...
<div align="center"><img src="vl-final-with-alternate.png" alt="Default and production value sets" /></div>
...
<div align="center"><img src="vl-set-active.png" alt="Set the production value set as active" /></div>
...
<div align="center"><img src="vl-impact-awareness.png" alt="Impact awareness warning" /></div>
